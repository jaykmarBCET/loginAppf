...
export const deleteTodo = async (data)=>{
  try {
    const response = await axios.delete('https://loginappb.onrender.com/api/v1/users/dashboard/delete-list',data,{
      withCredentials:true,
    })
    return response.data;
  } catch (error) {
...
export const addTodo = async (data)=>{
  try {
    const response = await axios.post('https://loginappb.onrender.com/api/v1/users/dashboard/add-list',data,{
      withCredentials:true,
    })
    return response.data;
  } catch (error) {
